      ...
      <CardContent className="px-6 py-4 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant={urdfSourceMode === "ros-topic" ? "default" : "outline"}
              size="sm"
            ...
            <Button
              variant={urdfSourceMode === "static-file" ? "default" : "outline"}
              size="sm"
          ...
          <div className="flex items-end gap-2">
            <Button
              ...
              disabled={
                isLoadingURDF ||
                status !== "connected" ||
                (urdfSourceMode === "ros-parameter" && !urdfParameterName) ||
        ...
        {/* TF Settings */}
        <div className="space-y-3">
          <Label className="text-sm font-medium">Transform (TF) Settings</Label>
        ...
        <div className="space-y-3">
          <Label className="text-sm font-medium">Joint States Settings</Label>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 rounded-lg border bg-white">
              <div className="flex-1">
            ...
            <div className="space-y-2">
              <Label htmlFor="joint-topic" className="text-xs text-gray-600">
                Joint States Topic
              </Label>
              <Input
                id="joint-topic"
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-gray-500">
              Set up an HTTP server in your Docker container to serve mesh files
            </p>
          </div>
