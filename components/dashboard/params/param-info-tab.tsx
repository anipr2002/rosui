    ...
    <TooltipProvider>
      <div className="space-y-4">
          ...
          <div className="flex justify-between items-start gap-3 py-2 border-b">
            ...
            <Tooltip>
              ...
              <TooltipContent side="top" className="max-w-xs">
                <p className="break-words font-mono text-xs">{paramName}</p>
              </TooltipContent>
            </Tooltip>
          </div>
              ...
              <div className="space-y-3">
                {watched?.isWatching ? (
                  ...
                  <div className="p-4 text-center border-2 border-dashed rounded-lg bg-gray-50">
                    <p className="text-xs text-gray-500">
                      Not currently watching this parameter. Use the Watch tab
                      to start monitoring.
                    </p>
                  </div>
                )}
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded-lg">
          <p className="text-xs text-gray-500">
            Use the Edit tab to modify this parameter, or the Watch tab to
