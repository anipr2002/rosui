...
export const TopicsEmptyState = forwardRef<HTMLDivElement>((props, ref) => {
  const titleId = useId()
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-xl">
          <motion.div
            className="absolute left-1/4 top-1/4 h-32 w-32 rounded-full bg-amber-400/5 blur-3xl"
            animate={{
              y: [0, -20, 0],
              x: [0, 10, 0],
            }}
          ...
          />
          <motion.div
            className="absolute bottom-1/4 right-1/4 h-24 w-24 rounded-full bg-orange-400/5 blur-3xl"
            animate={{
              y: [0, 15, 0],
              x: [0, -10, 0],
            }}
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <motion.div variants={CONTENT_VARIANTS} className="space-y-2 mb-4">
            ...
            <p id={descriptionId} className="text-sm text-gray-500 max-w-sm leading-relaxed">
              No ROS topics were found. Make sure your ROS system is running and publishing topics.
            </p>
          </motion.div>
        </div>
      </motion.section>
