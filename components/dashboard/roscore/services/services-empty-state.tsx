...
export const ServicesEmptyState = forwardRef<HTMLDivElement>((props, ref) => {
  const titleId = useId()
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-xl">
          <motion.div
            className="absolute left-1/4 top-1/4 h-32 w-32 rounded-full bg-teal-400/5 blur-3xl"
            animate={{
              y: [0, -20, 0],
              x: [0, 10, 0],
            }}
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <motion.div variants={CONTENT_VARIANTS} className="space-y-2 mb-4">
            <div className="flex items-center justify-center gap-2 mb-2">
              <ServerOff className="h-6 w-6 text-teal-600" />
              <h2
                id={titleId}
            ...
            <p id={descriptionId} className="text-sm text-gray-500 max-w-sm leading-relaxed">
              No ROS services were found. Make sure your ROS system is running and has services available.
            </p>
          </motion.div>
        </div>
      </motion.section>
...
ServicesEmptyState.displayName = "ServicesEmptyState"
